(() => {
  ...
  window.addEventListener("DOMContentLoaded", function ready() {
    ...
    const totalPopSlot = document.querySelector("#total-pop");
    const meanPopSlot = document.querySelector("#mean-pop");
    ...
    selectState.addEventListener("change", function (evt) {
      ...
      meanPopSlot.textContent = numberFormat.format(Math.floor(meanPopulation));
    });
  });
})();
